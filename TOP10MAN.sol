  ...
  /**
   * @title TOP10
   * @dev TOP10 is a token holder contract that allows the specified beneficiary
   * to claim stored tokens after 6 month intervals
  */

   contract TOP10 is SafeMath {
      ...
      function TOP10(address _token, uint256 fundingEndBlockInput) {
      ...
      // in total 13% of TOP10 tokens will be sent to this contract
